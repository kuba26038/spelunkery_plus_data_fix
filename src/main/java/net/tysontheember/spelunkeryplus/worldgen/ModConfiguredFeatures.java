...
public class ModConfiguredFeatures {
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_TUFF_SAPPHIRE_ORE_KEY = registerKey("tuff_sapphire_ore");
...
//                        ModBlocks.TUFF_SAPPHIRE_ORE.get().defaultBlockState()),
//                OreConfiguration.target(stoneReplaceable, ModBlocks.TUFF_SAPPHIRE_ORE.get().defaultBlockState()));
//
//        register(context, OVERWORLD_TUFF_SAPPHIRE_ORE_KEY, Feature.ORE, new OreConfiguration(overworldSapphireOres, 9));
    }
